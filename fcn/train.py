...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        writer.add_scalar('mean_loss', mean_loss, epoch, walltime=None)
        writer.add_scalar('lr', lr, epoch, walltime=None)


        confmat = evaluate(model, val_loader, device=device, num_classes=num_classes)
        val_info = str(confmat)
        # mean_iou = confmat.meanIou
        # print(mean_iou)
        print(val_info)
        # write into txt
...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"D:\semantic_segmentation_dateset", help="VOCdevkit root")
